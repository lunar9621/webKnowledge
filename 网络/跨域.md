...
ele.src = '...';
ele.onerror = function(){alert('error')}
ele.onload = function(){alert('load')}
document.body.appendChild(ele)
【https://www.cnblogs.com/antineutrino/p/jQuery-getJSON-handle-errors.html】
